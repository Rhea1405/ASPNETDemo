<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="ASPNETDemo.update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table style="border-spacing:30px">
        ...
        <tr>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Update" OnClick="Button1_Click" OnClientClick="return ivalidate();" BackColor="White" BorderColor="Black" Font-Bold="True" Font-Overline="False" Font-Size="X-Large" ForeColor="Black"/></td>
        </tr>
        <tr>
            <td>
