<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="sessionex1.aspx.cs" Inherits="ASPNETDemo.sessionex11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="border-spacing:30px">
        ...
        <tr>
            <td>
                <asp:Button ID="Button1" runat="server" Text="insert" OnClick="Button1_Click" OnClientClick="return ivalidate();" BackColor="White" BorderColor="Black" Font-Bold="True" Font-Overline="False" Font-Size="X-Large" ForeColor="Black" Height="35px" Width="172px"/></td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
